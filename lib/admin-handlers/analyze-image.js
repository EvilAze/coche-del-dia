...
// Modelo por defecto: el más capaz (mejor juicio visual). Override por env si
// quieres abaratar (p.ej. claude-haiku-4-5 es ~5× más barato y suficiente para
// este scoring). Una llamada por alta de coche → coste despreciable a tu escala.
