...
7. **Coherencia de los niveles de zoom.** Si tocas `ZOOM_LEVELS` (`useGame.js`), actualiza también `Z_TO_CROP_PCT` (`api/daily-image.js`) y `ZOOM_PREVIEWS` (`src/admin/FocusPicker.jsx`).
