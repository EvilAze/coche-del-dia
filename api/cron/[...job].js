...
// estábamos justo en el tope; en vez de gastar un slot por cron, los jobs
// (warm-daily, send-push) viven en `api/_lib/cron/` (prefijo _
...
//   · /api/cron/warm-daily → job=["warm-daily"] (Vercel Cron, diario; también
//                            cierra las temporadas terminadas, PASO 6)
